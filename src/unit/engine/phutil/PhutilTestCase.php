...
/* -(  Making Test Assertions  )--------------------------------------------- */
   ...
   *
   * @param mixed    The empirically derived value, generated by executing the
   *                test.
   ...
   *
   * @param mixed    The theoretically expected value, generated by careful
...
/* -(  Exception Handling  )------------------------------------------------- */
   ...
   *    }
   *
   * @param array<string, mixed>       Map of test case labels to test case inputs.
  ...
  final protected function tryTestCases(
    ...
    foreach ($inputs as $idx => $input) {
      ...
      if ($expect === $actual) {
        ...
        if ($expect && $caught instanceof Exception) {
          $message = pht(
   ...
   *
   * @param array<string, mixed>       Map of scalar test inputs to expected success (true
